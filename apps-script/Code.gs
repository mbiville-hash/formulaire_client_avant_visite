...
function buildPdfHtml_(data) {
  ...
  return '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"/>' +
    ...
    '.photos-section{break-inside:avoid;page-break-inside:avoid}.photos{display:grid;grid-template-columns:repeat(2,1fr);gap:10px}.photo{background:#e8e2d8;border:1px solid var(--line);overflow:hidden}.photo img{width:100%;height:auto;display:block;max-height:220px;object-fit:contain}' +
